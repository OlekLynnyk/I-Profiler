      ...
      <section className="md:hidden px-6 max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col justify-between min-h-[90svh] pb-[env(safe-area-inset-bottom)] pt-4">
          <div className="space-y-3">
            {/* H1 */}
            <h1 className="font-extrabold uppercase tracking-tight leading-[1.1] text-[clamp(2.75rem,10vw,4.25rem)]">
              <span className="block text-white">We Unlock Insights With</span>
              <span className="block text-white">Advanced Profiling</span>
            </h1>

            {/* Subtitle */}
            <div className="font-bold mt-3 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#B98AF6] via-[#A855F7] to-[#B98AF6] text-[clamp(1rem,4.5vw,1.375rem)]">
              <div>FROM AN IMAGE OF A FLEETING DETAILS</div>
              <div>TO SEEING WHAT OTHERS NEVER GRASP</div>
            </div>

            {/* Description */}
            <p className="text-[13px] leading-snug text-white/70 max-w-[36ch]">
      ...
      <main className="hidden md:flex lg:flex-row items-center justify-between flex-grow text-left px-6 mt-10 gap-12 max-w-7xl mx-auto relative z-10">
        <div className="w-full lg:w-[80%] space-y-2 pl-[20px]">
          <div className="min-h-[4rem]">
            <h1 className="font-extrabold uppercase tracking-tight leading-[1.05] [text-wrap:balance] text-[clamp(3.75rem,5vw+1rem,5.75rem)]">
              <span className="block text-white">We Unlock Insights With</span>
              <span className="block text-white">Advanced Profiling</span>
            </h1>

            <div className="font-bold mt-3 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#B98AF6] via-[#A855F7] to-[#B98AF6] text-[22.0px]">
              <div>FROM AN IMAGE OF A FLEETING DETAILS</div>
              <div>TO SEEING WHAT OTHERS NEVER GRASP</div>
            </div>
          </div>
