...
const animatedLines = [
  {
    lines: ['Unlock Insights with Advanced Profiling — Tailored for Business', 'Powered by AI'],
  },
  {
    lines: [
...
export default function AnimatedHeadline() {
  ...
  return (
    <div className="relative min-h-[8rem] overflow-hidden">
      <div
        className={clsx('absolute inset-0 transition-all duration-700 ease-in-out transform', {
